...
Namespace EnrollmentDBDataSetTableAdapters
    ...
    Partial Public Class DEPARTMENTTableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(1).CommandText = "SELECT id, name, description FROM dbo.DEPARTMENT"
        ...
        Public Overloads Overridable Function FillBy(ByVal dataTable As EnrollmentDBDataSet.DEPARTMENTDataTable) As Integer
